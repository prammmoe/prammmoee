...
var anime = (function () {
  var t = {
    ...
    A = function (t) {
      var n = /-?\d*\.?\d+/g;
      return { numbers: u(t).match(n) ? u(t).match(n).map(Number) : [0], strings: u(t).split(n) };
    },
    k = function (t) {
    ...
    Q = function (t, n, e, a) {
      ...
      return { from: u.length > 1 ? u[0] : O(t, n), to: u.length > 1 ? u[1] : u[0] };
    },
    D = function (t, n, e, r) {
      var a = {};
    ...
    C = function (n, e) {
      ...
      return (n.currentValues = { progress: a, full: x(a, n.to.strings, n.from.strings) }), n.currentValues.full;
    },
    S = function (t, n) {
      var e = void 0;
      if (
          ...
          (e.tick = function () {
            n.running &&
              ...
              e.current >= n.totalDuration
                ? (n.settings.loop
                    ? ((e.start = +new Date()), r.number(n.settings.loop) && n.settings.loop--, 'alternate' === n.settings.direction && n.interpolations.forEach(B), (e.raf = requestAnimationFrame(e.tick)))
                    : ((n.ended = !0), n.settings.complete ? n.settings.complete(n) : n.pause()),
                  (e.last = 0))
